...
export default function DataTable({ columns, data = [], isLoading, onEdit, onDelete, searchKeys = [], emptyMessage = "Nenhum registro encontrado", canEdit = true, canDelete = true, extraActions }) {
