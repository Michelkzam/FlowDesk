...
export const SYSTEM_PAGES = [
  ...
  { id: "chat.principal", label: "Mensagens", path: "/chat", category: "Chat", icon: "MessageSquare" },
  { id: "chat.meus", label: "Meus Atendimentos", path: "/chat/meus", category: "Chat", icon: "Inbox" },
  { id: "chat.filas", label: "Filas", path: "/chat/filas", category: "Chat", icon: "ListTodo" },
  { id: "chat.historico", label: "Histórico Chat", path: "/chat/historico", category: "Chat", icon: "History" },
  { id: "chat.respostas", label: "Respostas Rápidas Chat", path: "/chat/respostas", category: "Chat", icon: "Zap" },
  { id: "chat.whatsapp", label: "Vincular WhatsApp", path: "/chat/vincular-whatsapp", category: "Chat", icon: "Link" },
  { id: "chat.telegram", label: "Vincular Telegram", path: "/chat/vincular-telegram", category: "Chat", icon: "Link" },
...
export const TICKET_STATUSES = {
  open: { key: "open", label: "Aguardando", color: "bg-yellow-400", textColor: "text-yellow-800", dotColor: "bg-yellow-500", badgeCls: "bg-yellow-100 text-yellow-700 border-yellow-200" },
  in_progress: { key: "in_progress", label: "Em Atendimento", color: "bg-blue-500", textColor: "text-white", dotColor: "bg-blue-500", badgeCls: "bg-blue-100 text-blue-700 border-blue-200" },
  closed: { key: "closed", label: "Finalizado", color: "bg-zinc-500", textColor: "text-white", dotColor: "bg-zinc-500", badgeCls: "bg-zinc-100 text-zinc-700 border-zinc-200" },
};
...
export const AGENT_STATUSES = ["open", "in_progress"];

export const ADMIN_ONLY_STATUSES = ["closed"];
